...
class EventContentRulesPrediction(object):
    def __init__(self):
    ...
    def train(self):
        ...
        pickle.dump(classificator, open('predict-event__content-rules-model-' + timestr + '.pkl', 'wb'))
    ...
    def predict(self, query):
        ...
        regex = re.compile(r'predict-event__content-rules-model-\d{8}-\d{6}\.pkl$')
