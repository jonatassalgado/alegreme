...
stopwords.extend([
    '01', 'r', 'r$', '2009', 'abertura', 'abril', 'aceitos', 'acesso',
    ...
    'graduada', 'grande', 'grandes', 'grupo', 'grupos', 'gt', 'história',
    'hoje', 'hora', 'horas', 'horário', 'horários', 'http', 'https', 'humano',
    'há', 'ideias', 'identidade', 'identificação', 'idosos', 'importantes',
    ...
    'janeiro', 'joão', 'julho', 'junho', 'já', 'la', 'lado', 'lei',
...
class EventCategoryPrediction(object):
    ...
    def train(self):
        ...
        classificator = Pipeline([
            ...
            ('clf-svm', SGDClassifier(alpha=0.0001, loss='log', penalty='l1'))
        ])
        ...
        for prediction in predictions:
            ...
            predictions_labels.append(
                classificator.classes_[best_two_labels_index])
        ...
        x = [[label[0], y_test[idx], X_test[idx][:45]]
