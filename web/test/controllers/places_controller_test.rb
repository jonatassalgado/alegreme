...
class PlacesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create place" do
    assert_difference('Place.count') do
      post places_url, params: { place: { address: @place.address, name: @place.details_name } }
    end
  ...
  test "should update place" do
    patch place_url(@place), params: { place: { address: @place.address, name: @place.details_name } }
