class FollowController < ApplicationController
	...
	def follow
		...
		@association = FollowServices::AssociationCreator.new(current_user, params[:resource_id], params[:type]).call
	...
	def unfollow
		@association = FollowServices::AssociationCreator.new(current_user, params[:resource_id], params[:type]).call(destroy: true)

		render json: @association

		#parse_params
		#
		#@association = FollowServices::AssociationCreator.new(current_user.id, follow_params[:resource_id]).call(destroy: true)
		#@topics      = get_topics
		#@data        = mount_locals
		#
		#render_component
	...
	def follow_params
		params.permit(:identifier, :user, :event_id, :type, :expand_to_similar, :resource_id)
	end
