class UsersController < ApplicationController
	...
	def agenda
		@liked_events = (current_user&.liked_events&.includes(:place)&.not_ml_data&.active&.order_by_date || Event.none) + (current_user&.liked_screenings&.includes(:movie) || Screening.none)
		render layout: false if @stimulus_reflex
	end
