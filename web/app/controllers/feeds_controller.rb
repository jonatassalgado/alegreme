...
class FeedsController < ApplicationController
	...
	def requested_events
		if params[:day]
			Event.includes(:place, :categories).valid.in_day(params[:day]).not_ml_data.order_by_date
			...
			@category.events.not_ml_data.active.valid.order_by_date.includes(:place, :categories)
		elsif params[:theme]
