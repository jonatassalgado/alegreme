class FeedsController < ApplicationController
  ...
  def train
    @events = {
      underground: Event.by_persona(:underground).not_retrained.limit(8),
      praieiro: Event.by_persona(:praieiro).not_retrained.limit(8),
      cult: Event.by_persona(:cult).not_retrained.limit(8),
      aventureiro: Event.by_persona(:aventureiro).not_retrained.limit(8),
      geek: Event.by_persona(:geek).not_retrained.limit(8),
      hipster: Event.by_persona(:hipster).not_retrained.limit(8),
      turista: Event.by_persona(:turista).not_retrained.limit(8),
      zeen: Event.by_persona(:zeen).not_retrained.limit(8),
      festa: Event.by_category(:festa).not_retrained.limit(8),
      show: Event.by_category(:show).not_retrained.limit(8),
      teatro: Event.by_category(:teatro).not_retrained.limit(8),
      curso: Event.by_category(:curso).not_retrained.limit(8),
      cinema: Event.by_category(:cinema).not_retrained.limit(8),
      exposicao: Event.by_category('exposição').not_retrained.limit(8),
      feira: Event.by_category(:feira).not_retrained.limit(8),
      aventura: Event.by_category(:aventura).not_retrained.limit(8),
    }
