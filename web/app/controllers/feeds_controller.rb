				...
				@items = if params[:q]
					         get_events_for_search_query
						       ...
						       collection_personas = collections.call(
								       'user-personas',
								       {
										       not_in: collection_follow[:detail][:init_filters_applyed][:events_ids] | collection_today[:detail][:init_filters_applyed][:events_ids]
								       })

						       collection_suggestions = collections.call(
								       'user-suggestions',
								       {
										       not_in: collection_personas[:detail][:init_filters_applyed][:events_ids] | collection_follow[:detail][:init_filters_applyed][:events_ids] | collection_today[:detail][:init_filters_applyed][:events_ids]
								       })
