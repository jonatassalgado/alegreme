...
class OrganizersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create organizer" do
    assert_difference('Organizer.count') do
      post organizers_url, params: { organizer: { name: @organizer.name, url: @organizer.url } }
    end
  ...
  test "should update organizer" do
    patch organizer_url(@organizer), params: { organizer: { name: @organizer.name, url: @organizer.url } }
